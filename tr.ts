export const TR = {
  ...
  NoLiquidityTurnOffAutoSell:
    "Pazarda %{res} için yeterli likidite yok, otomatik satış kapatıldı",
  ...
  ScienceFromPowerDesc:
    "Enerji santralleri, güç üretirken az miktarda Bilim üretir",
  Culture: "Kültür",
  School: "Okul",
  ...
  BuildingLocked:
    "Bina henüz mevcut değil, önce araştırma laboratuarında kilidini açmanız gerekir ",
  ...
  SolarPanelDesc:
    "💡 Güneş Panelleri her 10 saniyede sadece 5 saniye çalışır - tüm döngüler hizalıdır",
  WindTurbineDesc:
    "💡 Rüzgar Türbinleri her 10 saniyede yalnızca 8 saniye çalışır - döngüler hizalı değildir",
  Movie: "Film",
  ...
  AdjacentBonusDesc:
    "Aynı türdeki her bitişik çalışan bina için %{bonus}% ekstra kapasite elde edersiniz",
  ...
  AlwaysTransportInputDesc:
    "Minimum üretim gereksiniminin üzerinde olsalar bile kaynakları daima taşıyın",
  ...
  BuildingValuationDesc:
    "Total value of your buildings, including building permits and upgrades",
  ...
  OfflineEarningTimeDesc:
    "You will earn offline earning for up to this threshold",
  ...
  Icons: "İkonlar",
  MisplacedBuilding:
    "⛔ This %{building} is not placed on top of the correct resource deposit",
  ...
  InputStrategyCloseDesc:
    "Prefer the closest warehouse which has enough resources",
  InputStrategyFar: "Farther",
  InputStrategyFarDesc:
    "Prefer the farthest warehouse which has enough resources",
  InputStrategyAmount: "Amount",
  InputStrategyAmountDesc:
    "Prefer the warehouse with the largest amount of the resources, regardless of distance",
  ...
  Screen: "Ekran",
  JoinDiscord:
    "Join our Discord server for latest updates, tips and discussions",
  ...
  EffectiveTimeDesc:
    "Your effective offline earning time is capped at %{time}min.",
  ...
  NewOrder:
    "A new order from %{from} has arrived, please check in Wholesale Center",
  Policies: "Politikalar",
  PolicyNotEnoughTime: "You don't have enough policy points for this policy",
  WholesaleCenterOrderFasterDesc:
    "Wholesale Center receives orders 2x faster and the order size is 2x bigger",
  ...
  CostSaverBuildingWarning:
    "Cost Saver policy is active, you cannot manually change production",
  ...
  SolarPanelAlwaysWorkDesc:
    "Solar panel works 100% of the time but produces 60% less power",
  ...
  MapExtraPermitDesc:
    " %{number} kadar bedeva yapı izni aldın,haritanın's özel bonusu nedeniyle",
  OsloBonusV3:
  ...
  PumpkinBatteryDesc:
    "All buildings that consume battery use pumpkin instead (BEDAVA POLİTİKA)",
  PumpkinSteel: "Balkabağı Çeliği",
  PumpkinSteelDesc:
    "All buildings that consume steel use pumpkin instead (BEDAVA POLİTİKA)",
